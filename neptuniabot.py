...
def secureStart():
   ...
   try:
       ...
       try:
           print("Bot Online at: ", currentTime)   # If the login is successful, log it to the system.
    ...
    if profanityFilterSwitch == 0:
        ...
        for word in swearList:
            if message.content.count(word) > 0:
                ...
                await message.channel.send("You can't say that here! It's unwholesome!")
